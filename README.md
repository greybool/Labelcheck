...
Screenshots below are taken on the synthetic demo label (`data/samples/demo_label.pdf`):

| Step 1 — recognised blocks, editable text | Step 2 — verdict with quotation, decision and rating |
|---|---|
| ![Step 1](docs/img/step1_layout.png) | ![Step 2](docs/img/step2_check.png) |

| Step 3 — work plan | Step 4 — monitoring on the demo journal |
|---|---|
| ![Step 3](docs/img/step3_plan.png) | ![Step 4](docs/img/step4_monitoring.png) |
...
claim, a material code without the Mobius loop. On the reference run the system
found all of them (1 possible violation, 3 manual checks, 14 compliant, 1 not
applicable; ~3 minutes, ≈ $1). Real layouts used during development are private
...
docs/            PIPELINE.md (what is built, with numbers) · REVIEW-LOG.md (acceptance
                 findings R-01…R-41 with root causes) · TZ-LABELCHECK.md (spec) · WORKING-PRACTICES.md
...
`docs/REVIEW-LOG.md` — журнал приёмки владельцем: 41 замечание с разбором по
